...
import type { Blocker, Fetcher, FormEncType, FormMethod, GetScrollRestorationKeyFunction, History, HydrationState, Router as RemixRouter } from "@remix-run/router";
...
export declare type BlockerFunction = () => {
    shouldBlock(): boolean;
    unstable_skipStateUpdateOnPopNavigation?: boolean;
};
export declare function useBlocker(shouldBlock: boolean | (() => boolean) | BlockerFunction): Blocker;
export declare function usePrompt(message: string | null | false, opts?: {
