...
function useBlocker(_shouldBlock) {
  ...
  let fn = React.useCallback(() => {
    if (typeof _shouldBlock === "function") {
      let result = _shouldBlock();
  ...
  let [blocker, setBlocker] = React.useState(router.createBlocker(blockerKey, fn));
...
export { BrowserRouter, Form, HashRouter, Link, NavLink, ScrollRestoration, useScrollRestoration as UNSAFE_useScrollRestoration, createBrowserRouter, createHashRouter, createSearchParams, HistoryRouter as unstable_HistoryRouter, useBeforeUnload, useBlocker, useFetcher, useFetchers, useFormAction, useLinkClickHandler, usePrompt, useSearchParams, useSubmit };
